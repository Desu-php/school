...
class TaskWheelFortuneController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        foreach ($questions as $question) {
            ...
            $newQuestion = TaskWheelFortuneQuestion::create($questionData);

            foreach ($question['answers'] as $answer) {
                $answerData = [
                    'answer' => $answer['answer'],
                    'correct_answer' => isset($answer['correct_answer']) ? true : false,
                    'task_wheel_fortune_question_id' => $newQuestion->id
                ];

                TaskWheelFortuneAnswer::create($answerData);
            }
        }
    ...
    public function show($id)
    {
        ...
        $questions = TaskWheelFortuneQuestion::where('task_id', $id)->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        foreach ($questions as $question) {
            ...
            TaskWheelFortuneQuestion::withTrashed()->where('id', $question['id'])->update($questionData);

            foreach ($question['answers'] as $answer) {
                TaskWheelFortuneAnswer::updateOrCreate(
                    ['id' => $answer['id']],
                    ['answer' => $answer['answer'], 'correct_answer' => $answer['correct_answer'] === "true" ? 1 : 0, 'task_wheel_fortune_question_id' => $question['id']]
                );
            }
        }
    ...
    public function deleteAnswers(Request $request)
    {
        ...
        TaskWheelFortuneAnswer::withTrashed()->whereIn('id', $answers_id)->delete();
