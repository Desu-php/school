...
class TaskComposeTextController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $composeTextTask = TaskComposeText::create($composeTextData);

        return response()->json([
            'task' =>  new TaskResource($task),
            'compose_text'=> $composeTextTask
        ], 200);
    }
    ...
    public function show($id)
    {
        ...
        $composeText = TaskComposeText::where('task_id', $id)->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        TaskComposeText::withTrashed()->where('task_id', $id)->update($composeTextData);
        $composeTask = TaskComposeText::withTrashed()->where('task_id', $id)->first();
