...
class TaskGallowController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'field_of_dreams.word'   => "required|string|max:9",
    ...
    public function show($id)
    {
        ...
        $word = TaskGallow::where('task_id', $id)->first();
...
//            dd($request->field_of_dreams['amount_numbers']);
        ...
        TaskGallow::withTrashed()->where('task_id', $id)->update($word);
